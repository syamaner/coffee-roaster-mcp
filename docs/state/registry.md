...
E3-S4 is complete. The Hottop driver now owns serial connection lifecycle with lazy pyserial transport creation, command-loop thread startup, idempotent disconnect, thread join, and serial cleanup covered by mocked transport tests.
